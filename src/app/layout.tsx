...
export const metadata: Metadata = {
  title: "Lorem Ipsum Generator — freeq.one",
  description: "Generate placeholder text instantly. Choose between paragraphs, words, or bytes. Copy to clipboard with history tracking. Part of the freeq.one tools suite.",
};
